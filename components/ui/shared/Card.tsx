...
export default function Card({event, hasOrderLink, hidePrice}: CardProps) {
  ...
  return (
    <div className="group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white dark:bg-black/15 shadow-md transition-all hover:shadow-lg md:min-h-[438px]">
      <Link
